...
<div class="banner" style="background:linear-gradient(rgba(0,0,0,.25), rgba(0,0,0,.25)),url(<?php echo get_field('product_category_page_banners', $post_id);?>) top center no-repeat;background-size:cover;">
