  ...
  public function get_settings() {
  	...
  	<?php
  	 $settings = array(  	 	 
		...
		'name' => __( 'Enter Popup Width In px', $DC_Checkout_Terms_Conditions_Popup->text_domain ),
		'type' => 'number',
		'class' => 'text',
		'desc' => __( 'Enter Popup Width in px only numeric value allowed here.', $DC_Checkout_Terms_Conditions_Popup->text_domain ),
		'desc_tip' => true,
