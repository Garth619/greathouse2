...
class DC_Checkout_Terms_Conditions_Popup_Frontend {
	...
	function add_pop_up() {
		...
		if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) { 
			...
			$line = $pre_text."  <a class='simple_popup_show' href='Javascript:void(0);' title=''>".$link_text."</a><span class='required'>*</span>  "; 
			...
			.simplepopup {<?php if(isset($this->terms_conditions_popup_div_width) && $this->terms_conditions_popup_div_width != '' ) { ?> width: <?php echo $this->terms_conditions_popup_div_width;?>px; <?php }?>
			<?php if(isset($this->terms_conditions_popup_div_width) && $this->terms_conditions_popup_div_width != '' ) { ?> min-width: <?php echo $this->terms_conditions_popup_div_width;?>px; <?php }?> }		
			...
			jQuery(document).ready(function($){
				...
				$( window ).resize(function() {
					if(($( window ).width()*90/100) < (<?php echo $this->terms_conditions_popup_div_width; ?>)) {
						...
						var width_new = '<?php echo $this->terms_conditions_popup_div_width; ?>'+ px;
